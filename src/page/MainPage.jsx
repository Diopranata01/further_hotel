        ...
        <div className="container-fluid text-center mx-0 p-0 container-content">
          <div className="content">
            <p>
              ...
              sea. In their evolution, bonds are forged, ideas take flight, and
          ...
          <div className="container-fluid d-flex flex-column flex-md-row text-align px-4">
            ...
            >
              <div className="content-sticky">
                ...
                <p>
                  Diverging from the conventional hospitality typology, Further
                  takes the form of a diffused hotel, reimagining a long-lost
                  concept that disperses the elements of a guest experience –
                  rarefied spaces for sleep, rejuvenation, and celebration –
                  throughout a village, respectfully weaving into the fabric of
                  its community.
                </p>
                <p>
                  ...
                  with common spaces attune to vibrant local sights, sounds, and
                  rhythms. In the transitions between experiences, opportunities
                  catalyse for encounters, exchange and togetherness.
                </p>
              </div>
            </div>
          ...
          <div className="container-fluid d-flex justify-content-center align-items-start flex-column flex-md-row gap-5 text-align px-4 px-md-5">
            ...
            <div className="col-12 col-md-6 text-wrapper">
              ...
              <p>
                ...
                queen-sized bed in a calm 53 m2 space with superlative proximity
                to the elements and plentiful room to reconnect – with nature,
          ...
          <div className="container-fluid d-flex justify-content-center align-items-start flex-column flex-md-row gap-4 text-align px-4 px-md-5">
            <div className="col-12 col-md-4 text-wrapper ">
              ...
              <p>
                ...
                multi-layered street activities of the village, which evolve and
                change on a seasonal basis. On the other hand, through their
                manifestation and architecture, the Further buildings speak to
                the spiritual fabric of the place, by engaging with the
                presence, materiality and regular geometry of the small temples
                that are found in the area. Such a relationship is supported by
                the character of muted monumentality that the hotel displays,
                generating a timeless and lasting quality.
              </p>
              <p>DISCOVER MORE</p>
            </div>
            <div className="col-12 col-md-4 text-wrapper ">
            ...
            <div className="col-12 col-md-4 text-wrapper ">
              ...
              <p>
                ...
                featuring all your beloved ST. ALi classics. And don’t forget to
                stay refreshed with our wide selection of iced beverages, ready
          ...
          <div className="container-fluid d-flex justify-content-center align-items-start flex-column flex-md-row gap-2 gap-md-5 text-start px-4 px-md-5">
            <div className="col-12 col-md-8 text-wrapper">
              ...
              <p>
                ...
                introduce our “Friends of Further”—a curated group of local and
                international businesses that align with our ethos and enrich
                the guest experience. Oaken Lab elevates your daily grooming
                rituals with artisanal skincare and grooming products. St. Ali
                brings a Melbourne-style café culture to Further, delivering
                specialty coffee and mouth-watering dishes. Smile provides
                organic and sustainable fashion choices that make you feel as
                good as you look. And Thomas Surfboards doesn’t just offer
                boards; they offer a lifestyle, encouraging everyone to catch
                waves and good vibes. Together, these tenants create a holistic
                and enriching experience that speaks to the essence of what
                Further Hotel is all about.
              </p>
            </div>
            <div className="col-12 col-md-4 text-wrapper">
              ...
              <p>
                ...
                purpose-driven lifestyle brand that’s handpicked all the in-room
                furniture and art, as well as crafted our artisanal signature
                FURTHER fragrance. Each element they bring adds meaningful depth
                to your experience.
              </p>
            </div>
          </div>
          ...
          <div className="container-fluid d-flex justify-content-center align-items-start flex-column flex-md-row gap-2 gap-md-5 text-start px-4 px-md-5">
            <div className="col-12 col-md-4 text-wrapper">
              ...
              <p>
                ...
                Canggu, Bali. Nestled among picturesque rice fields and close to
                the ocean, our location offers a perfect blend of tranquility
                and accessibility. Guests can enjoy the beautiful sunsets, surf
                spots, and vibrant local culture, all within a short distance
                from the hotel. The beach is easily reachable, making it
                convenient for those looking to explore the natural beauty of
                Bali. Our proximity to local cafes, the Wrong GYM, and various
                cultural sites ensures that guests have plenty of options to
                explore and enjoy during their stay with us
              </p>
            </div>
            <div className="col-12 col-md-8 text-wrapper">
        ...
        <div className="container-fluid text-center mx-0 p-0 container-content-location">
          <div className="container-fluid d-flex justify-content-center align-items-start flex-column flex-md-row gap-4 text-start px-4 px-md-5">
            <div className="col-12 col-md-5 col-lg-4 text-wrapper ">
              ...
              <p>
                For those opting for a private car or taxi, the journey through
                Bali’s picturesque landscapes will lead you directly to our
                doors, making the commute a pleasurable start to your stay with
                us. Additionally, our hotel airport pickup service is available
                for a smooth and comfortable transition, with a travel time of
                approximately 45 minutes to an hour, depending on traffic
                conditions.
              </p>
            </div>
          </div>
        ...
        <section className="section-accomodation mt-4 mt-md-5">
          <div className="container-fluid d-flex justify-content-center align-items-start flex-column flex-md-row gap-5 text-start px-4 px-md-5">
            ...
            <div className="col-12 col-md-4 text-wrapper">
              ...
              <p>GET DIRECTION</p>
              <p>
                Bali Airport (Ngurah Rai) Denpasar – Indonesia 45-60 minutes by
                car
              </p>
            </div>
          </div>
          ...
          <div className="container-fluid d-flex justify-content-center align-items-start flex-column flex-md-row gap-5 text-start px-4 px-md-5">
            ...
            <div className="col-12 col-md-4 text-wrapper">
              <p>
                ...
                Today, the hotel stands as a symbol of the perfect blend between
                contemporary design and tradi- tional Balinese culture, always
                evolving, with ongoing proj- ects that continue to enrich the
                guest experience. The story of FURTHER HOTEL is not just a
                history; it is an ongoing journey in discovering and celebrating
